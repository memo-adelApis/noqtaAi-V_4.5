...
export default function InvoiceSummary({
    ...
    return (
        <div className="bg-white p-5 rounded-lg shadow-md border sticky top-6">
            <h3 className="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                <DollarSign size={18} className="ml-2 text-green-500" />
                ملخص الفاتورة
            </h3>
            ...
            <div className="space-y-3 mb-4">
                 <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">الخصم</label>
                    <input
                        type="number"
                        value={discount}
                 ...
                 <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">إضافات (مثل الشحن)</label>
                    <input
                        type="number"
                        value={extra}
                 ...
                 <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">العملة</label>
                    <select value={currency} onChange={(e) => onCurrencyChange(e.target.value)} className="w-full p-2 border border-gray-300 rounded-md bg-white">
            ...
            <div className="space-y-2 border-t pt-4">
                ...
                <div className="flex justify-between text-gray-600">
                    <span>الخصم:</span>
                    <span className="font-medium text-red-600">({formatNumber(discount)}) {currency}</span>
                </div>
                {summary.vatAmount > 0 && (
                     <div className="flex justify-between text-gray-600">
                        <span>الضريبة:</span>
                 ...
                 <div className="flex justify-between text-gray-600">
                    <span>الإضافات:</span>
                    <span className="font-medium text-green-600">(+{formatNumber(extra)}) {currency}</span>
                </div>
                <hr className="my-2"/>
                ...
                <div className="flex justify-between text-lg font-semibold text-blue-600">
                 ...
                 <div className="flex justify-between text-2xl font-bold text-red-700 bg-red-50 p-3 rounded-md">
