...
function CustomerFormModal({ isOpen, onClose, customerToEdit, onSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const args = isEditMode ? [customerToEdit._id, formData] : [formData];
...
export default function CustomerClientUI({ initialCustomers }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="p-4">
                    <h2 className="text-xl font-semibold">العملاء الحاليون ({initialCustomers.length})</h2>
                </div>
                {initialCustomers.length > 0 ? (
                    <div className="divide-y divide-gray-200">
                        {initialCustomers.map(customer => (
                            <div key={customer._id} className="p-4 flex flex-col sm:flex-row justify-between sm:items-center hover:bg-gray-50">
